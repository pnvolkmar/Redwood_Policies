#
# Ind_Construction_CA.jl - Construction equipment: 25% energy demand
# electrified by 2030 and 75% by 2045
#

using SmallModel

module Ind_Construction_CA
...
function IndPolicy(db)
  ...
  for tech in techs, enduse in enduses
    DmFracMin[enduse,Electric,tech,Construction,CA,Yr(2030)] = 
      max(DmFracMin[enduse,Electric,tech,Construction,CA,Yr(2030)],0.25)
  end

  years = collect(Yr(2045):Final)
  for year in years, tech in techs, enduse in enduses
    DmFracMin[enduse,Electric,tech,Construction,CA,year] = 
      max(DmFracMin[enduse,Electric,tech,Construction,CA,year],0.75)
  end
  ...
  for year in years, tech in techs, enduse in enduses
    DmFracMin[enduse,Electric,tech,Construction,CA,year] = 
      DmFracMin[enduse,Electric,tech,Construction,CA,year-1]+
        (DmFracMin[enduse,Electric,tech,Construction,CA,Yr(2030)]-
          DmFracMin[enduse,Electric,tech,Construction,CA,Yr(2021)])/(2030-2021)
  end
  ...
  for year in years, tech in techs, enduse in enduses
    DmFracMin[enduse,Electric,tech,Construction,CA,year] = 
      DmFracMin[enduse,Electric,tech,Construction,CA,year-1]+
        (DmFracMin[enduse,Electric,tech,Construction,CA,Yr(2045)]-
          DmFracMin[enduse,Electric,tech,Construction,CA,Yr(2030)])/(2045-2030)
  end

  years = collect(Yr(2022):Final)
  for year in years, tech in techs, enduse in enduses
    xDmFrac[enduse,Electric,tech,Construction,CA,year] = 
      DmFracMin[enduse,Electric,tech,Construction,CA,year]
  end
...
function PolicyControl(db)
  @info "Ind_Construction_CA.jl - PolicyControl"
  IndPolicy(db)
end
