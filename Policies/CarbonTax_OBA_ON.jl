#
# Policies/CarbonTax_OBA_ON.jl - Federal Carbon Tax with OBA for ON
#
...
function ElecPolicy(db)
  ...
  #########################
  # 
  # Backstop Prices in nominal CN$/tonne become effective in Jan, 2019. 
  #
  CN = Select(Nation,"CN")
  US = Select(Nation,"US")
...
function PolicyControl(db)
  @info "Policies/CarbonTax_OBA_ON.jl - PolicyControl"
  ElecPolicy(db)
end
