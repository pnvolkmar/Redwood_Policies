...
rem unknown
  ...
  Call CreateSinglePolicy_Inputs Eff_MB_Act                 jl Policies StartBase Base Base OGRef Base
  Call CreateSinglePolicy_Inputs EIP_CCS_2                  jl Policies StartBase Base Base OGRef Base
  Call CreateSinglePolicy_Inputs Electric_Renew_NS          jl Policies StartBase Base Base OGRef Base
  Call CreateSinglePolicy_Inputs Electricity_ITCs           jl Policies StartBase Base Base OGRef Base
  Call CreateSinglePolicy_Inputs Electricity_Patch          jl Policies StartBase Base Base OGRef Base
  Call CreateSinglePolicy_Inputs EndogenousElectricCapacity jl Policies StartBase Base Base OGRef Base
